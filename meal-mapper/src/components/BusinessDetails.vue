        ...
        <div>
          <div class="title">
            ...
            <div class="busName">
              ...
              <span v-if="!!business.marker.gsx$provideraddloc.$t">{{
                business.marker.gsx$provideraddloc.$t
              }}</span>
              <template v-if="!!business.marker.gsx$cuisine.$t">{{
                business.marker.gsx$cuisine.$t
              }}</template>
            </div>
          </div>
          ...
          <p>
            <icon-list-item
              v-if="
                business.marker.gsx$discountmedical != undefined &&
                business.marker.gsx$discountmedical.$t == 1
              "
              icon="fas fa-user-md"
            ...
            <icon-list-item
              v-if="
                business.marker.gsx$freegroceries != undefined &&
                business.marker.gsx$freegroceries.$t == 1
              "
              icon="fas fa-shopping-basket"
              :title="$tc('label.freegroceries', 1)"
            />
            <icon-list-item
              v-if="business.marker.gsx$curbside.$t == 1"
              icon="fas fa-car"
              :title="$tc('label.curbside', 1)"
            />
            <icon-list-item
          ...
          <p>
            <icon-list-item
              v-if="
                business.marker.gsx$contact !== undefined &&
                !!business.marker.gsx$contact.$t
              "
            ...
            <icon-list-item
              v-if="
                business.marker.gsx$contactspanish !== undefined &&
                !!business.marker.gsx$contactspanish.$t
              "
              icon="fas fa-phone-alt"
              :title="
                business.marker.gsx$contactspanish.$t +
                ' (' +
                $t('languages.es').toLowerCase() +
                ')'
              "
            ...
            <icon-list-item
              v-if="
                business.marker.gsx$weblink !== undefined &&
                !!business.marker.gsx$weblink.$t
              "
              icon="fas fa-globe"
            ...
            <icon-list-item
              v-if="
                business.marker.gsx$twitter !== undefined &&
                !!business.marker.gsx$twitter.$t
              "
              icon="fa fa-twitter"
              :title="'@' + business.marker.gsx$twitter.$t"
              :link="
                'https://www.twitter.com/' + business.marker.gsx$twitter.$t
              "
            />

            <icon-list-item
              v-if="
                business.marker.gsx$instagram !== undefined &&
                !!business.marker.gsx$instagram.$t
              "
              icon="fa fa-instagram"
              :title="'@' + business.marker.gsx$instagram.$t"
              :link="
                'https://www.instagram.com/' + business.marker.gsx$instagram.$t
              "
            />

            <icon-list-item
              v-if="
                business.marker.gsx$facebook !== undefined &&
                !!business.marker.gsx$facebook.$t
              "
            ...
            <icon-list-item
              v-if="
                business.marker.gsx$email !== undefined &&
                !!business.marker.gsx$email.$t
              "
          ...
          <template
            v-if="
              business.marker.gsx$instructions !== undefined &&
              !!business.marker.gsx$instructions.$t
            "
          >
            <p>
          ...
          <template
            v-if="
              business.marker.gsx$offers !== undefined &&
              !!business.marker.gsx$offers.$t
            "
          >
            <p>
          ...
          <template
            v-if="
              business.marker.gsx$notes !== undefined &&
              !!business.marker.gsx$notes.$t
            "
          >
            <p>
              <b>{{ $t("label.notes") }}:</b><br />{{
                business.marker.gsx$notes.$t
              }}
            </p>
          </template>
